        ...
        <div className="shadow-xl">
            ...
            {product && 
                ...
                <div class="xl:max-w-lg xl:ml-auto">
                    {product.image && 
                        <img class="mt-6 rounded-lg shadow-xl sm:mt-8 sm:h-64 sm:w-full sm:object-cover sm:object-center lg:hidden" src={`${config.base_url}/images/${product.image}`} alt={`/images/${product.image}`}/>}
                    <span class="text-xl uppercase text-indigo-500">{'>'+product.type}</span>
                    ...
                    {product.marque},{product.qualite}
                    <br class="hidden lg:inline" />
                    </span>
                    <span class="text-xl text-indigo-400">{'Couleur'+product.couleur}</span>
                    <br class="hidden lg:inline" />
                    <span class="text-sm text-gray-500">{'Prix: '+product.prix}</span>
                    <br class="hidden lg:inline" />
                ...
                {product.image && 
                <img class="absolute inset-0 h-full w-full object-cover object-center" src={`../img/${product.image}`}  alt="Woman workcationing on the beach "/>}
                </div>
            </div>
            }
        </div> 
